...
def main(target, cluster_numbers, model_names):
    for cluster in cluster_numbers:
        for model_name in model_names:
            ...
            csv_path_2 = f'/rds/general/user/cb1319/home/GEOM3D/Geom3D/fragment_experiment_2/{cluster}_cluster_{target}_model_inferences_totalset.csv'
            ...
            if os.path.exists(csv_path_2):
                ...
                df_2 = pd.DataFrame()
            config_dir = f"/rds/general/user/cb1319/home/GEOM3D/Geom3D/fragment_experiment_2/{target}_experiment/{model_name}_opt_{target}_80000_{cluster}"
