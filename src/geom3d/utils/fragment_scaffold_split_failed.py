...
def fragment_scaffold_splitter(dataset, config):
    ...
    split_file_path = config["running_dir"] + f"/datasplit_{num_mols}_{config['split']}_threshold_{config['fragment_cluster_threshold']}.csv"
    ...
    if os.path.exists(split_file_path):
        ...
        print(f"Dataset not found. Calculating dataset cluster assignments...")
        ...
        # Save split indices to the file as a dataframe
